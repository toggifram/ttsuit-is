      ...
      <div className="mt-12 space-y-10 text-[15px] leading-relaxed text-ink/75">
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            afslátt af gjafabréfum og tilbúnum fatnaði. Afslátturinn gildir
            ekki um sérsaum. Við sendum kóðann á netfangið þitt. Ein tilboð
            per netfang. Þú getur afskráð þig hvenær sem er.
          </p>
        </section>
