...
const PEACOAT: SizeChart = {
  ...
  legend: [
    ...
    { n: 3, label: "Axlir", detail: "Mál jakkans milli axlaenda" },
    { n: 4, label: "Ermi", detail: "Mál ermar frá öxl að úlnlið" },
    { n: 5, label: "Lengd", detail: "Mál jakkans frá öxl niður að faldi" },
  ],
  columns: [
